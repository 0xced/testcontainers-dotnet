...
public abstract class ClickHouseContainerTest(ClickHouseContainerTest.ClickHouseFixture fixture)
{
    ...
    [UsedImplicitly]
    public sealed class ClickHouseDefault(ClickHouseFixture fixture) : ClickHouseContainerTest(fixture), IClassFixture<ClickHouseFixture>;

    [UsedImplicitly]
    public sealed class ClickHouseWaitForDatabase(ClickHouseWaitForDatabaseFixture fixture) : ClickHouseContainerTest(fixture), IClassFixture<ClickHouseWaitForDatabaseFixture>;
