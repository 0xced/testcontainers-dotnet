...
{
    public const string SnowflakeImage = "localstack/snowflake:0.2.5";
    ...
    {
        return base.Init()
            .WithImage(SnowflakeImage)
            .WithPortBinding(SnowflakePort, assignRandomHostPort: true)
            .WithWaitStrategy(Wait.ForUnixContainer().UntilInternalTcpPortIsAvailable(SnowflakePort));
    }
