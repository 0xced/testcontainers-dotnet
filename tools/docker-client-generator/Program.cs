...
var url = new Uri(args.Length > 0 ? args[0] : "https://docs.docker.com/reference/api/engine/version/v1.51.yaml");
...
static void GenerateClientFiles(OpenApiDocument document)
{
    var settings = new CSharpClientGeneratorSettings
    {
        ...
        ResponseArrayType = "IReadOnlyCollection",
        ResponseDictionaryType = "IReadOnlyDictionary",
